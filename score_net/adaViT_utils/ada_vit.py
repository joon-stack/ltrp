...
import numpy as np
from score_net.adaViT_utils.token_transformer import Token_transformer
from score_net.adaViT_utils.token_performer import Token_performer
from score_net.adaViT_utils.transformer_block import Block, get_sinusoid_encoding
from score_net.adaViT_utils.ada_transformer_block import StepAdaBlock, get_random_policy
...
class AdaStepT2T_ViT(nn.Module):
    def __init__(self, img_size=224, tokens_type='performer', in_chans=3, num_classes=1000, embed_dim=768, depth=12,
                 ...
                 ada_token=False, ada_token_with_mlp=False, ada_token_start_layer=0, ada_token_pre_softmax=True,
                 ada_token_detach_attn=True, ada_token_detach_attn_at_mlp=False,
                 keep_layers=1,
        ...
        self.blocks = nn.ModuleList([
            StepAdaBlock(
                ...
                ada_token_pre_softmax=ada_token_pre_softmax, ada_token_detach_attn=ada_token_detach_attn,
                dyna_data=dyna_data, ada_head_v2=ada_head_v2, ada_token_detach_attn_at_mlp=ada_token_detach_attn_at_mlp,
    ...
    def forward_features(self, x):
        ...
        for blk in self.blocks:
            x, attn, this_head_select, this_layer_select, this_token_select, this_head_select_logits, this_layer_select_logits = blk(
                x)
        ...
        return x[:, 0], head_select, layer_select, token_select, attn_list, hidden_list, dict(
            head_select_logits=head_select_logits, layer_select_logits=layer_select_logits)
