...
from score_net.mobile_former_utils.mobile_former_helpers import build_model_with_cfg
from score_net.mobile_former_utils.mobile_former_dna_blocks import _make_divisible, MergeClassifier, Local2Global
...
def mobile_former_26m( pretrained=False, num_classes=196, **kwargs):
