...
from score_net.evit_utils.evit_helpers import build_model_with_cfg, named_apply, adapt_input_conv
...
class EViT(nn.Module):
    ...
    def get_visible_tokens_idx(self, x, len_keep):
        ...
        _, ids_keep = self.forward(x, keep_rate, get_idx=True)
        ids_keep = get_real_idx(ids_keep, True)
        ids_keep = ids_keep[-1]  # [B, N]
...
evit_small = deit_small_patch16_shrink_base